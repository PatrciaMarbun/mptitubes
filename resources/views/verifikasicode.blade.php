...
input.otp-input::-webkit-inner-spin-button { -webkit-appearance: none; margin: 0; }
input.otp-input { -moz-appearance: textfield; }
.input-error { border-color: #dc2626; }
.error-text { color: #dc2626; font-size: 0.875rem; margin-top: 0.25rem; text-align: center; display: none; }
</style>
</head>
