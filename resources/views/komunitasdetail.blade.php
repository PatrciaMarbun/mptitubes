...
<body class="bg-[#05284C] min-h-screen flex flex-col">
  ...
  <!-- SECTION BUKU -->
  <section id="bukukomunitasdetail" class="flex justify-center items-start px-6 md:px-10 pt-[120px] pb-20">
  ...
  <div class="md:hidden fixed bottom-0 left-0 w-full bg-[#F1EFEC] border-t border-gray-300 flex justify-around py-2 shadow-lg z-50">
    ...
    <a href="/bukukomunitas" class="flex flex-col items-center text-gray-800 px-4 py-2 rounded-md" style="background-color: #D4C9BE;"><i data-lucide="book-text" class="w-6 h-6"></i><span class="text-xs mt-1">Buku Komunitas</span></a>
