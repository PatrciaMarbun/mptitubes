...
<nav class="bg-[#F1EFEC] w-full shadow-sm py-5 px-10 flex justify-between items-center fixed top-0 left-0 z-50">
  ...
  <div class="hidden md:flex items-center gap-12 text-gray-800">
    ...
    <a href="/resmi" class="flex items-center gap-2 hover:text-[#05284C]"><i data-lucide="play" class="w-5 h-5"></i>Buku Resmi</a>
  ...
  <!-- Tombol Menu Mobile -->
  <button id="BukuresmiBtn" class="md:hidden border border-gray-400 p-2 rounded-md hover:bg-gray-100">
  ...
  {{-- Menu Mobile --}}
  <div id="BukuresmiMobile" class="hidden flex flex-col bg-[#F1EFEC] p-4 space-y-3 md:hidden mt-[80px] rounded-b-3xl">
...
<section id="hero-bukuresmi" class="flex justify-center items-start px-6 md:px-10 pt-[100px]">
  <div class="bg-[#F1EFEC] rounded-[40px] w-full max-w-7xl p-8 md:p-16 shadow-lg">
    ...
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-6">
      <h2 class="text-2xl md:text-3xl font-bold text-gray-800 mb-4 md:mb-0">Riwayat Unduh</h2>
