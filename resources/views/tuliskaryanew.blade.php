...
<body class="bg-[#05284C] min-h-screen flex flex-col">
  ...
  <!-- Konten Tulisan Karya -->
  <section id="tuliskaryanew" class="flex justify-center items-start px-6 md:px-10 pt-[120px] pb-20">
  ...
  <script>
    ...
    window.addEventListener('click', e => {
      if (!mobileBtn.contains(e.target) && !mobileDropdown.contains(e.target)) mobileDropdown.style.display = 'none';
    });
  </script>
</body>
</html>
