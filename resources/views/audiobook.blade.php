...
<body class="bg-[#05284C] min-h-screen flex flex-col">
  ...
  <section id="hero-audiobook" class="flex justify-center items-start px-6 md:px-10 pt-[100px] pb-20">
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div class="bg-white rounded-2xl shadow p-4 flex flex-col">
          ...
          <div class="mt-4 flex justify-end gap-2">
            ...
            <a href="/audiobookdetail" class="bg-purple-600 text-white rounded-full px-3 py-1 text-sm hover:bg-purple-700 transition">Primary</a>
          </div>
        </div>
        <div class="bg-white rounded-2xl shadow p-4 flex flex-col">
          <div class="flex justify-between items-start mb-4">
