...
<nav class="bg-[#F1EFEC] w-full shadow-sm py-5 px-10 flex justify-between items-center fixed top-0 left-0 z-50">
  ...
  <!-- Tombol Menu Mobile -->
  <button id="ArtikelBtn" class="md:hidden border border-gray-400 p-2 rounded-md hover:bg-gray-100">
  ...
  {{-- Menu Mobile --}}
  <div id="MobileArtikel" class="hidden flex flex-col bg-[#F1EFEC] p-4 space-y-3 md:hidden mt-[80px] rounded-b-3xl">
 ...
 {{-- Hero Section --}}
<section id="hero-artikel" class="flex justify-center items-start px-6 md:px-10 pt-[100px]">
