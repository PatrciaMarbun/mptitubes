...
<body class="bg-[#05284C] min-h-screen flex flex-col">
  ...
  <nav class="hidden md:flex bg-[#F1EFEC] w-full shadow-sm py-5 px-10 justify-between items-center fixed top-0 left-0 z-50">
    ...
    <div class="flex items-center gap-12 text-gray-800">
      ...
      <a href="/artikel" class="flex items-center gap-2 bg-[#D4C9BE] px-5 py-2 rounded-full hover:text-[#05284C]"><i data-lucide="edit" class="w-5 h-5"></i>Artikel</a>
  ...
  <section id="hero-artikel" class="flex justify-center items-start px-6 md:px-10 pt-[100px] pb-20">
    <div class="bg-[#F1EFEC] rounded-[40px] w-full max-w-7xl p-8 md:p-16 shadow-lg">
      <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-6">
        <h2 class="text-2xl md:text-3xl font-bold text-gray-800 mb-4 md:mb-0">Artikel</h2>
        <div class="flex items-center bg-white rounded-full px-3 py-1 shadow-sm w-full md:w-64">
          ...
          <input type="text" placeholder="Cari artikel..." class="w-full text-sm text-gray-700 outline-none bg-transparent">
        </div>
      </div>
  ...
  <div class="md:hidden fixed bottom-0 left-0 w-full bg-[#F1EFEC] border-t border-gray-300 flex justify-around py-2 shadow-lg z-50">
    ...
    <a href="/artikel" class="flex flex-col items-center text-gray-800 px-4 py-2 rounded-md" style="background-color: #D4C9BE;"><i data-lucide="edit" class="w-6 h-6"></i><span class="text-xs mt-1">Artikel</span></a>
  </div>
